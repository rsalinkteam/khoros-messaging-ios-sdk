...
typedef void (^SMMAuthenticationCompletionBlock)(NSString *jwt);
 ...
 */
@protocol SMMAuthenticationDelegate <NSObject>
 ...
 */
- (void)onInvalidToken:(NSError *) error handler:(SMMAuthenticationCompletionBlock)completionHandler;
