...
#import "SMMAuthenticationDelegate.h"
 ...
 */
extern NSString * const SMMMenuItemCamera;
 ...
 *
 *  @param appId A valid app id retrieved from the Lithium web portal.
 *  @param authCode A valid auth code generated from the Lithium API.
 */
 ...
 *
 *  @discussion App id can be retrieved from the Lithium web portal
 *
 ...
 *
 *  @discussion Auth code can be retrieved from the Lithium API
 *
 *  This value may only be set once, and must be set at init time.
 */
...
/**
 *  @abstract The Lithium region for this account.
 *
 ...
 *
 *  @discussion Valid values are SMMMenuItemCamera, SMMMenuItemGallery, SMMMenuItemDocument and SMMMenuItemLocation
 *
 ...
 *
 *  @discussion When set to YES, Lithium will swizzle the following methods of your UIApplicationDelegate in order to automatically handle push notification receiving and registering, as well as user notification handling.
 *
 ...
 *
 *  If set to NO, Lithium will not perform swizzling. It is up to the app to handle Lithium push notifications by doing the following:
 *
 *  1. When a new push token is received in -application:didRegisterForRemoteNotificationsWithDeviceToken:, you must call Lithium +setPushToken.
 *  2. In your -application:didReceiveRemoteNotification: or -application:didReceiveRemoteNotification:fetchCompletionHandler: callback, you must call Lithium +handlePushNotification: with the passed userInfo dictionary.
 *  3. In your -application:handleActionWithIdentifier:forRemoteNotification:withResponseInfo:completionHandler: callback, you must call Lithium +handleUserNotificationActionWithIdentifier:withResponseInfo:completionHandler: with the correct parameters.
 *
 ...
 *
 *  @discussion For more information, see the +userNotificationCenterDelegate method of the Lithium class.
 *
 *  If set to NO, the application must forward calls from its own UNUserNotificationCenterDelegate to Lithium to ensure proper handling of notifications on iOS 10.
 *
 *  The default value is YES.
 *
 *  @see Lithium
 ...
 *
 *  If set to NO, the application must make sure to register the Lithium user notification category settings. For more information, see the +userNotificationCategories method of the Lithium class.
 *
 *  The default value is YES.
 *
 *  @see Lithium
 ...
 *  This value may only be set once, and must be set at init time.
 *
 *  @see SMMAuthenticationDelegate
 */
@property(nullable) id<SMMAuthenticationDelegate> authenticationDelegate;
